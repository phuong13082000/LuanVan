...
CREATE TABLE IF NOT EXISTS `cauhinhs` (
  ...
  `dungluong` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'Dưới 5.000.000', 'duoi-5000000', 0),
(2, 'Từ 5.000.000 đến 10.000.000', 'tu-5000000-den-10000000', 0),
(3, 'Từ 10.000.000 đến 20.000.000', 'tu-10000000-den-20000000', 0),
(4, 'Từ 20.000.000 đến 30.000.000', 'tu-20000000-den-30000000', 0),
(5, 'Trên 30.000.000', 'tren-30000000', 0);
