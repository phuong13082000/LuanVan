...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `code_order` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `huybo` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `orders` (`id`, `user_id`, `shipping_id`, `status`, `code_order`, `huybo`, `created_at`, `updated_at`) VALUES
(16, 8, 17, '1', '5c1e8', '0', '2022-10-15 09:31:35', '2022-10-15 09:31:35');
...
CREATE TABLE IF NOT EXISTS `order_details` (
  ...
  `sanpham_name` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sanpham_gia` int NOT NULL,
...
(11, '5c1e8', 12, 'Adapter Sạc Type C MHJE3', 690000, '2', '2022-10-15 09:31:35', '2022-10-15 09:31:35');
...
(12, 'Adapter Sạc Type C MHJE3', 'adapter-sac-type-c-mhje3', 'adapter-sac-type-c-20w-cho-iphone-ipad-apple-mhje3-avatar-1-1-600x6004722.jpg', 690000, 0, '10', '<ul><li>Adapter sạc nhanh Type C dành cho iPhone, iPad.</li><li>Thiết kế nhỏ gọn, chuôi 2 chấu phổ biến.</li><li>Cổng ra Type-C, kết nối thêm dây cáp để sạc cho điện thoại, máy tính bảng.</li><li>Công suất 20 W cho tốc độ sạc nhanh chóng.</li><li>Sản phẩm chính hãng Apple, nguyên seal 100%.</li></ul>', 0, '<h3>Thiết kế gọn đẹp, đầu cắm 2 chấu phổ biến</h3><p>Kiểu dáng&nbsp;adapter sạc&nbsp;đơn giản, trang nhã, chất lượng tốt cho độ bền cao. Thiết kế đầu cắm loại có 2 chấu quen thuộc, dùng được với các ổ điện ở mọi nơi từ nhà cho tới công sở, trường học, nhà hàng, khách sạn,...</p><p><a href=\"https://cdn.tgdd.vn/Products/Images/58/230315/adapter-sac-type-c-20w-cho-iphone-ipad-apple-mhje3-264920-024901.jpg\"><img src=\"https://cdn.tgdd.vn/Products/Images/58/230315/adapter-sac-type-c-20w-cho-iphone-ipad-apple-mhje3-264920-024901.jpg\" alt=\"Adapter Sạc Type C 20W dùng cho iPhone/iPad Apple MHJE3 Trắng - Thiết kế gọn đẹp\"></a></p><h3>Sạc nhanh qua cổng ra Type-C công suất mạnh mẽ 20 W</h3><p>Đặc biệt, tích hợp công nghệ Power Delivery hỗ trợ sạc nhanh ở nhiều dòng điện áp khác nhau, giúp thiết bị được nạp đầy năng lượng trong thời gian ngắn một cách an toàn, tối ưu nhất.</p><p>Cổng Type-C khá thông dụng nên cho adapter làm việc được với nhiều loại&nbsp;cáp sạc&nbsp;trên thị trường như&nbsp;cáp Type-C - Type-C,&nbsp;cáp Type-C - Lightning.</p><p><a href=\"https://cdn.tgdd.vn/Products/Images/58/230315/adapter-sac-type-c-20w-cho-iphone-ipad-apple-mhje3-264920-024907.jpg\"><img src=\"https://cdn.tgdd.vn/Products/Images/58/230315/adapter-sac-type-c-20w-cho-iphone-ipad-apple-mhje3-264920-024907.jpg\" alt=\"Adapter Sạc Type C 20W dùng cho iPhone/iPad Apple MHJE3 Trắng - Sạc nhanh qua cổng ra Type-C công suất mạnh mẽ 20W\"></a></p><h3>Apple MHJE3 phù hợp 100% với các dòng iPhone, iPad</h3><p>Sử dụng&nbsp;Adapter sạc Apple&nbsp;này để nạp pin cho&nbsp;iPhone, iPad của bạn không những cho khả năng kết nối cao, tăng tuổi thọ cho pin mà còn giúp bảo vệ người dùng và thiết bị hiệu quả.</p><p><a href=\"https://cdn.tgdd.vn/Products/Images/58/230315/adapter-sac-type-c-20w-cho-iphone-ipad-apple-mhje3-264820-024854.jpg\"><img src=\"https://cdn.tgdd.vn/Products/Images/58/230315/adapter-sac-type-c-20w-cho-iphone-ipad-apple-mhje3-264820-024854.jpg\" alt=\"Adapter Sạc Type C 20W dùng cho iPhone/iPad Apple MHJE3 Trắng - Apple MHJE3 phù hợp 100% với các dòng iPhone, iPad\"></a></p><p>Nếu hành trang thường nhật của bạn đang thiếu 1 chiếc&nbsp;adapter&nbsp;sạc nhanh&nbsp;chính hãng tin cậy của Apple thì mẫu&nbsp;adapter Sạc Type C cho 20W dùng cho iPhone/iPad Apple MHJE3 trắng&nbsp;chắc chắn là lựa chọn tuyệt vời, chọn mua ngay để trải nghiệm khả năng sạc ấn tượng của em nó nào!</p>', 2, '2022-10-09 21:26:56', '2022-10-15 07:28:25');
...
CREATE TABLE IF NOT EXISTS `shippings` (
  `id` int NOT NULL AUTO_INCREMENT,
  `shipping_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `shipping_diachi` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `shipping_phuongthuc` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL,
  `updated_at` timestamp NOT NULL,
  PRIMARY KEY (`id`)
...
(16, 'phuong', 'a2/47a', 356929673, 'hoangphuong0813@gmail.com', 'asd', '0', '2022-10-15 02:30:46', '2022-10-15 02:30:46'),
(17, 'phuong', 'a2/47a', 356929673, 'hoangphuong0813@gmail.com', 'asd', '0', '2022-10-15 02:31:35', '2022-10-15 02:31:35');
...
(8, 'Admin', 'hoangphuong0813@gmail.com', NULL, '0356929673', 'a2 /47 a ap 1 xa phong phu huyen binh chanh thanh pho ho chi minh', '$2y$10$6xTBV2Bk65vJ6SSkBbIJn.l0nuGtZ2d2UwyMkZCMA4eEfitsEm0oC', NULL, '2022-10-15 00:52:07', '2022-10-15 02:29:22');
...
ALTER TABLE `sanphams`
  ADD CONSTRAINT `sanphams_ibfk_1` FOREIGN KEY (`danhmuc_id`) REFERENCES `danhmucs` (`id`);

--
-- Constraints for table `sanpham_theloai`
--
ALTER TABLE `sanpham_theloai`
  ADD CONSTRAINT `sanpham_theloai_ibfk_1` FOREIGN KEY (`sanpham_id`) REFERENCES `sanphams` (`id`),
  ADD CONSTRAINT `sanpham_theloai_ibfk_2` FOREIGN KEY (`theloai_id`) REFERENCES `theloais` (`id`);
COMMIT;
